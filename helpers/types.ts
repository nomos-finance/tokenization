...
export enum eHecoNetwork {
  htestnet = "htestnet",
  heco = "heco",
}

export enum eHooNetwork {
  hoo = "hoo",
}
...
export type iParamsPerNetwork<T> =
  ...
  | iHecoParamsPerNetwork<T>
  | iHooParamsPerNetwork<T>
  | iArbitrumParamsPerNetwork<T>
  | iBscParamsPerNetwork<T>
  | iOkexParamsPerNetwork<T>;
...
export interface iHecoParamsPerNetwork<T> {
  [eHecoNetwork.htestnet]: T;
  [eHecoNetwork.heco]: T;
}

export interface iHooParamsPerNetwork<T> {
  [eHooNetwork.hoo]: T;
}

export interface iArbitrumParamsPerNetwork<T> {
  [eArbitrumNetwork.amain]: T;
  [eArbitrumNetwork.arinkeby]: T;
}

export interface iBscParamsPerNetwork<T> {
  [eBscNetwork.bsc]: T;
  [eBscNetwork.bsctestnet]: T;
}

export interface iOkexParamsPerNetwork<T> {
  [eOkexNetwork.okex]: T;
}
